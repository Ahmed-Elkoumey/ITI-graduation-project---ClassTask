...
function Home() {
  ...
  {/*** ************************************** second card **********************************/}
      ...
      <div className=" d-flex">
        ...
        <Button variant="primary" onClick={handleShow1}  className="button-56 ms-5"  >
      ...
      <Button variant="primary" onClick={handleShow} className='button-56 ms-5 '>
    ...
    <Table  bordered hover>
      <thead>
        <tr>
          ...
          <th> <Button variant="danger">Delete All</Button>{' '}</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className="id">#12583A</td>
          <td className="cell" ><Link to="/Class" className="cell"> Math J4</Link></td>
